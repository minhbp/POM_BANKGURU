...
public class ApiUI {
	...
	public static final String DYNAMIC_SHOWTIMES_H = "//body[contains(text(), '%s')]";
	...
	public static final String API_NORMAL_URL = "https://webinaris.co/api/?key=24064W20110&is_paid=YES&firstname="
			+ fname + "&lastname=" + lname + "&ip_address=127.0.0.1&password=1bf050e3994fe2f68349aafd37dff16f&time="
			+ time + "&email=" + email + "&timezone=" + timezone + "&phone=" + phone + "&note=" + note + "&source_id="
			+ source_id + "&utm_content=" + utm_content + "&utm_source=" + utm_source
